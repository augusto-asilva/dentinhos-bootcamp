...
INSERT INTO USERS (name, last_name, dni, birth_date, phone, email, password, user_status, id_address)
VALUES ('dentinho0', 'dba0', 'DNIDNI0', '1990-07-21', '99009900', 'dentinho_2000@meli.com', 'dente', 'active', 1),
...
INSERT INTO dentists(id_user, code_mp)
VALUES (1, '124bc'),
       (2, '456de'),
       (3, '789fg');

INSERT INTO diaries(start_time, ending_time, id_dentist)
VALUES ('2021-07-21 09:00:00', '2021-07-21 18:00:00', 1),
       ('2021-07-22 09:00:00', '2021-07-22 18:00:00', 2),
       ('2021-07-23 09:00:00', '2021-07-23 18:00:00', 3);

INSERT INTO turns(days, id_diary, id_turn_status, id_patient)
VALUES ('2021-07-21', 1, 1, 4),
       ('2021-07-21', 1, 2, 5),
       ('2021-07-21', 1, 3, 6),
       ('2022-07-22', 2, 1, 7),
       ('2021-07-22', 2, 2, 8),
